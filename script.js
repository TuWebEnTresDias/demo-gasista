...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const Personalization = {
        ...
        init() {
            ...
            const company = rawCompany ? `${rawCompany} | Gas` : null;
            const name = rawName ? `${rawName} | Gasista` : null;
        ...
        apply({ type, value }) {
            // Update page title
            document.title = `${value} | Servicio de Gasista`;
            ...
            document.querySelectorAll('[data-dynamic]').forEach(el => {
                ...
                switch (key) {
                    ...
                    case 'footer-name':
                        ...
                        break;
                    case 'title':
                        el.textContent = `${value} | Servicio de Gasista`;
                        break;
                }
            });
        ...
        updateMeta(name) {
            ...
            if (meta) {
                meta.content = `${name} - Servicio profesional de gasista matriculado. Emergencias de gas, garantía en todos los trabajos.`;
            }
        }
    };
